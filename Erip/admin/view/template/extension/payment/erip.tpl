    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-erip"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="erip_merchant" value="<?php echo $erip_merchant; ?>"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="erip_webkey" value="<?php echo $erip_webkey; ?>"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="erip_expires" value="<?php echo $erip_expires; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="erip_status" id="input-status" class="form-control">
                                <?php if ($erip_status) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="erip_order_status_id" id="input-pending" class="form-control">
                                <?php foreach ($order_statuses as $order_status) { ?>
                                <?php if ($order_status['order_status_id'] == $erip_order_status_id) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="erip_processing_status_id" id="input-processing" class="form-control">
                                <?php foreach ($order_statuses as $order_status) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="erip_canceled_status_id" id="input-canceled" class="form-control">
                                <?php foreach ($order_statuses as $order_status) { ?>
                                <?php if ($order_status['order_status_id'] == $erip_canceled_status_id) { ?>
                                <option value="<?php echo $order_status['order_status_id']; ?>"
                                        selected="selected"><?php echo $order_status['name']; ?></option>
                                <?php } else { ?>
                                <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="erip_sort_order" value="<?php echo $erip_sort_order; ?>"
